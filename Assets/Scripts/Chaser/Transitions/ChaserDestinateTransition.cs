...
{
    public class ChaserDestinateTransition : Transition
    {
        ...
        public ChaserDestinateTransition(State nextState, ChaserModel model, ChaserView view,
        ...
        public override void Update()
        {
            if (_targetOperationsService.IsNearTo(_view.Transform.position, _model.Target.position,
                _botsConfigProvider.SquareDistanceToInteract))
                Open();
        }
    }
}
